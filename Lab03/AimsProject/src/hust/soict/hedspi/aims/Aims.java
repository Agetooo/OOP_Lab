...
public class Aims {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    Media cart1= store.findMediaByTitle(title);
                    cart.addMedia(cart1,store);
                    break;
                case 3:
    ...
    private static void updateStore() {
        ...
        if (choice == 1) {
            ...
            if (mediaChoice == 1) {  // DigitalVideoDisc
                System.out.print("Enter length: ");
                int length = Integer.parseInt(scanner.nextLine());
                System.out.print("Enter director: ");
                String director = scanner.nextLine();
                Media med = new DigitalVideoDisc(id, title, category, cost, length, director);
                store.addMedia(med);
            } else if (mediaChoice == 2) {  // Book
                System.out.print("Enter author(s): ");
                String author = scanner.nextLine();
                Media med = new Book(id, title, category, cost);
                ((Book) med).addAuthor(author);  // Add author to the book
                store.addMedia(med);
            } else if (mediaChoice == 3) {  // CompactDisc
                System.out.print("Enter length: ");
                int length = Integer.parseInt(scanner.nextLine());
                System.out.print("Enter director: ");
                String director = scanner.nextLine();
